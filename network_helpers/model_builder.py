...
from network_helpers.models.FC_DenseNet_Tiramisu import build_fc_densenet
from network_helpers.models.Encoder_Decoder import build_encoder_decoder
from network_helpers.models.RefineNet import build_refinenet
from network_helpers.models.FRRN import build_frrn
from network_helpers.models.MobileUNet import build_mobile_unet
from network_helpers.models.PSPNet import build_pspnet
from network_helpers.models.GCN import build_gcn
from network_helpers.models.DeepLabV3 import build_deeplabv3
from network_helpers.models.DeepLabV3_plus import build_deeplabv3_plus
from network_helpers.models.AdapNet import build_adaptnet
from network_helpers.models.custom_model import build_custom
from network_helpers.models.DenseASPP import build_dense_aspp
from network_helpers.models.DDSC import build_ddsc
from network_helpers.models.BiSeNet import build_bisenet
...
def download_checkpoints(model_name):
    subprocess.check_output(["python", "network_helpers/get_pretrained_checkpoints.py", "--model=" + model_name])



def build_model(model_name, net_input, num_classes, crop_width=None, crop_height=None, frontend="ResNet101", is_training=True):
	...
	if "ResNet50" == frontend and not os.path.isfile("network_helpers/models/resnet_v2_50.ckpt"):
	    download_checkpoints("ResNet50")
	if "ResNet101" == frontend and not os.path.isfile("network_helpers/models/resnet_v2_101.ckpt"):
	    download_checkpoints("ResNet101")
	if "ResNet152" == frontend and not os.path.isfile("network_helpers/models/resnet_v2_152.ckpt"):
	    download_checkpoints("ResNet152")
	if "MobileNetV2" == frontend and not os.path.isfile("network_helpers/models/mobilenet_v2.ckpt.data-00000-of-00001"):
	    download_checkpoints("MobileNetV2")
	if "InceptionV4" == frontend and not os.path.isfile("network_helpers/models/inception_v4.ckpt"):
