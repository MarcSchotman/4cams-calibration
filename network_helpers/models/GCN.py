...
from network_helpers import frontend_builder
import os, sys
...
def build_gcn(inputs, num_classes, preset_model='GCN', frontend="ResNet101", weight_decay=1e-5, is_training=True, upscaling_method="bilinear", pretrained_dir="network_helpers/models"):
    """
